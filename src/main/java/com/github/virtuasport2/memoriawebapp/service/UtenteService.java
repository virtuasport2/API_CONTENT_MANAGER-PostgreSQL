...
public class UtenteService {
    ...
    // Il costruttore non ha bisogno di essere modificato (l'encoder viene iniettato
    // da Spring)
    ...
    public boolean verifyUser(String email, String password) {
        ...
        // System.out.println("Entrato in verifyUser con username: " + username); //
        // Debug
        // Optional<Utente> userOpt = utenteRepository.findByUsername(username);
        ...
        // Optional<Utente> userOpt =
        // utenteRepository.findByUsernameIgnoreCase(username);
    ...
    // Metodo per salvare un nuovo utente, assicurandosi di criptare la password
    // prima
    ...
    // recupera l'utente autenticato - mi serve per quando creo un nuovo Documento o
    // Tipo Documento
